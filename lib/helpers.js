...
/**
 * Destructures the text and cards cards and recomposes as a single card/message object
 * @param {Object} textCard an object with a text property
 * @param {Object} cardsCard an object with a cards property
 * @returns {Object} an object with a text and cards property
 */
function composeCard(textCard, cardsCard) {
  let { text } = textCard;
  let { cards } = cardsCard;
  return { text, cards };
}
